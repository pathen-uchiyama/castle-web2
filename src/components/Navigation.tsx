    ...
    <>
      ...
      >
        ...
        <Link to="/" className="relative z-10 flex items-center gap-2.5">
          <img src={ccLogoLight} alt="Castle Companion" className={`h-10 w-auto transition-all duration-500 ${isHome ? "drop-shadow-[0_0_6px_hsla(42,64%,50%,0.4)] brightness-110" : ""}`} />
