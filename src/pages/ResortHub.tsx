      ...
      <section className="relative bg-foreground text-background px-8 lg:px-16 pt-32 pb-16">
        <motion.div {...fade()}>
          ...
          <div className="flex flex-wrap gap-3">
            <span className="px-3 py-1.5 text-[0.5625rem] uppercase tracking-[0.12em] border border-background/20 text-background/70">📍 {resort.size}</span>
            <span className="px-3 py-1.5 text-[0.5625rem] uppercase tracking-[0.12em] border border-background/20 text-background/70">🗓 Est. {resort.opened}</span>
          ...
          <div className="mt-6 flex gap-2">
            {["wdw", "dlr"].map(rid => (
              <Link key={rid} to={`/resort/${rid}`}
                className={`px-4 py-2 text-[0.5625rem] uppercase tracking-[0.12em] border transition-all ${
                    ...
                    <div className="p-6 lg:p-8">
                      ...
                      {parkAttractions.length > 0 && (
                        <button onClick={() => setExpandedPark(isExpanded ? null : park.parkId)}
                          className="flex items-center gap-2 mt-4 px-4 py-2 border border-border hover:border-foreground/30 transition-colors text-[0.5625rem] uppercase tracking-[0.12em] text-muted-foreground hover:text-foreground">
